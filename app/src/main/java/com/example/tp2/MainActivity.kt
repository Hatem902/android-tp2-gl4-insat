...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var studentsCours = arrayListOf<Student>(
            Student("Alain", "Macron", GenderEnum.male, StatusEnum.present),
            Student("Marie", "Noel", GenderEnum.female, StatusEnum.absent)
        )
        var studentsTp = arrayListOf<Student>(
            Student("Josef", "Lenoir", GenderEnum.male, StatusEnum.absent),
            Student("Simon", "Junior", GenderEnum.female, StatusEnum.present)
        )
        ...
        var matieres = listOf<String>("Seance de cours", "Seance de Tp")
        spinner.adapter =
